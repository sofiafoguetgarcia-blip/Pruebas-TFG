...
# IMAGEN / CONTORNOS
# =============================================================================
MAX_ANCHO_M         = 0.055 # Ancho máximo del dibujo en metros. Si la imagen es más ancha, se escala proporcionalmente.
EPSILON_PX          = 0.9   # Distancia máxima en píxeles para considerar que dos puntos del contorno pertenecen al mismo segmento.
...
V_SUBIDA    = 0.025          # Velocidad para movimientos de subida/descenso (Z), reducida para evitar golpes contra el papel.
