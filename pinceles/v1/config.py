...
UR3E_BOWL_FORCE_THRESHOLD = 1.2       # fuerza en N para detectar la pintura/cuenco
UR3E_BOWL_MAX_ITER = 12000            # limite de bajada para no quedarse buscando contacto
UR3E_BOWL_CONTACT_OFFSET = -0.004     # pequeno margen para introducir el pincel tras detectar contacto
UR3E_BOWL_LIFT_AFTER_DIP = 0.025      # subida despues de mojar antes de limpiar en los laterales
UR3E_DIP_REPETITIONS = 2              # numero de veces que moja el pincel
...
V_PINCEL_SUBIDA = 0.040               # velocidad de movimientos sin contacto
A_PINTURA = 0.020                     # aceleracion de las pasadas de pintura
A_PINCEL = 0.050                      # aceleracion de movimientos del pincel sin contacto
