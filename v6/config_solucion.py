...
V_SUBIDA    = 0.02          # Velocidad para movimientos de subida/descenso (Z), reducida para evitar golpes contra el papel.
...
V_HOME      = 0.1          # Velocidad para movimientos a home/origen. Puede ser más rápida que la velocidad de dibujo, pero no demasiado para evitar golpes.
