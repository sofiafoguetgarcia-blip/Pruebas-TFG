...
F_UMBRAL_UR5 = 1.5       # fuerza en N a partir de la cual se considera que hay contacto
...
Z_PAPEL = 0.0008     # margen que se deja sobre el papel una vez detectado el contacto
...
# Con 0.55 el dibujo usa el 55% del lado menor, dejando margen en los bordes.
...
# -----------------------------------------------------------------------------
EPSILON_PX = 0.7          # tolerancia de aproximacion de contornos (cv2.approxPolyDP)
DECIMATE_STEP = 2         # se coge un punto de cada N para reducir la densidad
MIN_PUNTOS_CONTORNO = 3   # minimo de puntos para que un contorno sea valido
MIN_LONGITUD_PX = 5       # longitud minima de un contorno en pixeles
MAX_PUNTOS_TOTAL = 1200   # limite total de puntos entre todos los trazos
