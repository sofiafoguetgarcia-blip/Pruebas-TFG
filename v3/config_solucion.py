...
F_UMBRAL    = 1.0           # Fuerza umbral para detectar colisiones. Si el robot detecta una fuerza mayor a este valor, se detiene por seguridad. Ajusta según tu configuración y pruebas.
