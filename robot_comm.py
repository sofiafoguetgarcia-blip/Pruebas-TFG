...
def ejecutar_flujo_completo(script_ur5_recoger: str, script_ur3_dibujar: str, script_ur5_devolver: str, ip_ur5e: str, ip_ur3e: str, port: int) -> None:
    ...
    log.info("PASO 7/9: preparando espera final del UR5e")
    ...
    log.info("PASO 8/9: enviando UR5e devolver")
    enviar_script(ip_ur5e, port, script_ur5_devolver)

    log.info("PASO 9/9: esperando a que UR5e termine de devolver")
    hilo5_fin.join()

    if err5_fin:
        raise err5_fin[0]

    log.info("Flujo completo enviado y terminado correctamente.")
